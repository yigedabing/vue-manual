...
var vue_runtime_esm = __webpack_require__(6427);
...
var vue_router_esm = __webpack_require__(7595);
...
const routes = [
  {
    name: '登录',
    path: '/login',
    component: () => __webpack_require__.e(/* import() */ 334).then(__webpack_require__.bind(__webpack_require__, 5334)),
  },
  {
    name: '第二期',
    path: '/page-v2',
    component: () => __webpack_require__.e(/* import() */ 341).then(__webpack_require__.bind(__webpack_require__, 7341)),
  },
  { path: '*', redirect: '/login' },
];
...
/******/ 			// return url for filenames based on template
/******/ 			return "css/" + chunkId + "." + {"334":"e3bf498e","341":"bc8b328e"}[chunkId] + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [998], () => (__webpack_require__(4065)))
