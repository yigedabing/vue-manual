...
(function (global, factory) {
  ...
  var Zepto = (function () {
    ...
    zepto.matches = function (element, selector) {
      ...
      var matchesSelector =
        element.matches || element.webkitMatchesSelector || element.mozMatchesSelector || element.oMatchesSelector || element.matchesSelector;
    ...
    function deserializeValue(value) {
      try {
        return value
          ? value == 'true' ||
              (value == 'false' ? false : value == 'null' ? null : +value + '' == value ? +value : /^[\[\{]/.test(value) ? $.parseJSON(value) : value)
          : value;
      } catch (e) {
        return value;
      }
    ...
    $.fn = {
      ...
      not: function (selector) {
        ...
        if (isFunction(selector) && selector.call !== undefined)
          ...
          var excludes =
            typeof selector == 'string' ? this.filter(selector) : likeArray(selector) && isFunction(selector.item) ? slice.call(selector) : $(selector);
